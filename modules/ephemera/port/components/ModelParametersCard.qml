...
SettingsCard {
    ...
    Column {
        ...
        // Temperature — hidden for models that don't accept sampling (Opus 4.7/4.8, OpenAI reasoning).
        Item { width: 1; height: Theme.spacingXS; visible: aiService.samplingSupported }
        Row {
            visible: aiService.samplingSupported
            width: parent.width
            spacing: Theme.spacingM
